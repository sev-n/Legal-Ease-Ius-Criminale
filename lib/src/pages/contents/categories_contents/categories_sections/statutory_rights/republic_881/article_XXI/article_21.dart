...
class SectionStatu21 extends StatelessWidget {
  const SectionStatu21({super.key});
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          final section = ListOfArticlesStatutory.sections881[index + 248];
                          return Column(
                            children: [
                              ListTile(
                                title: Text(
