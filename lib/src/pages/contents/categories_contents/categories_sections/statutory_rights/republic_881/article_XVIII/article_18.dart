...
class SectionStatu18 extends StatelessWidget {
  const SectionStatu18({super.key});
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          final section = ListOfArticlesStatutory.sections881[index + 205];
                          return Column(
                            children: [
                              ListTile(
                                title: Text(
