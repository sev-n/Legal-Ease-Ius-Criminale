...
class SectionStatu19 extends StatelessWidget {
  const SectionStatu19({super.key});
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          final section = ListOfArticlesStatutory.sections881[index + 220];
                          return Column(
                            children: [
                              ListTile(
                                title: Text(
