...
class SectionStatu17 extends StatelessWidget {
  const SectionStatu17({super.key});
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          final section = ListOfArticlesStatutory.sections881[index + 189];
                          return Column(
                            children: [
                              ListTile(
                                title: Text(
