...
class SectionStatu9 extends StatelessWidget {
  const SectionStatu9({super.key});
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          final section = ListOfArticlesStatutory.sections881[index + 62];
                          return Column(
                            children: [
                              ListTile(
                                title: Text(
