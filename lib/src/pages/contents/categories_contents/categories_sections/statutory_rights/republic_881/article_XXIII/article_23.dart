...
class SectionStatu23 extends StatelessWidget {
  const SectionStatu23({super.key});
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          final section = ListOfArticlesStatutory.sections881[index + 269];
                          return Column(
                            children: [
                              ListTile(
                                title: Text(
