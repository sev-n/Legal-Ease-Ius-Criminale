...
class SectionStatu25 extends StatelessWidget {
  const SectionStatu25({super.key});
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          final section = ListOfArticlesStatutory.sections881[index + 279];
                          return Column(
                            children: [
                              ListTile(
                                title: Text(
