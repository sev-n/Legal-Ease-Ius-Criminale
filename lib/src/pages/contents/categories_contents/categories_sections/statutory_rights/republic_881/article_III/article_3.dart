...
class SectionStatu3 extends StatelessWidget {
  const SectionStatu3({super.key});
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          final section = ListOfArticlesStatutory.sections881[index + 20];
                          return Column(
                            children: [
                              ListTile(
                                title: Text(
