...
class SectionStatu2 extends StatelessWidget {
  const SectionStatu2({super.key});
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          final section = ListOfArticlesStatutory.sections881[index + 12];
                          return Column(
                            children: [
                              ListTile(
                                title: Text(
