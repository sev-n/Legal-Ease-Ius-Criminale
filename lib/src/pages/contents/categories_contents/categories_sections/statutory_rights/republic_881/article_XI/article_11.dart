...
class SectionStatu11 extends StatelessWidget {
  const SectionStatu11({super.key});
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          final section = ListOfArticlesStatutory.sections881[index + 93];
                          return Column(
                            children: [
                              ListTile(
                                title: Text(
