...
class SectionStatu10 extends StatelessWidget {
  const SectionStatu10({super.key});
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          final section = ListOfArticlesStatutory.sections881[index + 78];
                          return Column(
                            children: [
                              ListTile(
                                title: Text(
