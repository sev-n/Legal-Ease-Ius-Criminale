...
class SectionStatu12 extends StatelessWidget {
  const SectionStatu12({super.key});
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          final section = ListOfArticlesStatutory.sections881[index + 112];
                          return Column(
                            children: [
                              ListTile(
                                title: Text(
