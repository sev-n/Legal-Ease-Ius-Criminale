...
class SectionStatu6 extends StatelessWidget {
  const SectionStatu6({super.key});
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          final section = ListOfArticlesStatutory.sections881[index + 36];
                          return Column(
                            children: [
                              ListTile(
                                title: Text(
