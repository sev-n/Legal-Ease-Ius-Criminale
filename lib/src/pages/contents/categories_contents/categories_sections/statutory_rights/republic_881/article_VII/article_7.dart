...
class SectionStatu7 extends StatelessWidget {
  const SectionStatu7({super.key});
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          final section = ListOfArticlesStatutory.sections881[index + 51];
                          return Column(
                            children: [
                              ListTile(
                                title: Text(
