                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                ...
                                'writing, signed and verified under oath by the applicant. It may be filed as an independent action '
                                'or as incidental relief in any civil or criminal case the subject matter or issues thereof partakes of '
                                'a violence as described in this Act. A standard protection order application form, written in '
                                ...
                                'the address of the victim will pose danger to her life, it shall be so stated in the application. In '
                                ...
                                'processing. An application for protection order filed with a court shall be considered an application for both a TPO and PPO. \n'
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 20.h),
                              Text(
                                'All TPOs and PPOs issued under this Act shall '
                                'be enforceable anywhere in the Philippines and a violation thereof shall be punishable with a '
                                'fine ranging from Five Thousand Pesos (P5,000.00) to Fifty Thousand Pesos (P50,000.00) '
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 20.h),
                              Text(
                                'If the woman or her child '
                                'requests in the applications for a protection order for the appointment of counsel because of '
