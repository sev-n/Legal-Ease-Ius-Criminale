...
class PersonContentOne extends StatelessWidget {
  const PersonContentOne({super.key});
...
class PersonContentTwo extends StatelessWidget {
  const PersonContentTwo({super.key});
...
class PersonContentThree extends StatelessWidget {
  const PersonContentThree({super.key});
...
class PersonContentFour extends StatelessWidget {
  const PersonContentFour({super.key});
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                ...
                                'the effectivity of this Act, to protect children against child prostitution and other sexual abuse; child trafficking, obscene publications and indecent shows; other acts of abuse; and circumstances which '
...
class PersonContentFive extends StatelessWidget {
  const PersonContentFive({super.key});
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                ...
                                'exploited in prostitution and other sexual abuse. The penalty of reclusion temporal in its medium period to reclusion perpetua shall be imposed upon the following:\n\n'
                                ...
                                'in prostitution in addition to the activity for which the license has been issued to said establishment.\n',
                                textAlign: TextAlign.justify,
                                style: TextStyle(
                                  fontFamily: "RobotoFlex",
                                  fontSize: 16.sp,
...
class PersonContentSix extends StatelessWidget {
  const PersonContentSix({super.key});
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                ...
                                'commit the crime of child prostitution under this Act, or, in the proper case, under the Revised Penal Code.\n',
                                textAlign: TextAlign.justify,
                                style: TextStyle(
                                  fontFamily: "RobotoFlex",
                                  fontSize: 16.sp,
...
class PersonContentSeven extends StatelessWidget {
  const PersonContentSeven({super.key});
...
class PersonContentEight extends StatelessWidget {
  const PersonContentEight({super.key});
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                ...
                                'can be offered for the purpose of child trafficking. A penalty lower two (2) degrees than that prescribed for the consummated felony under Section 7 '
...
class PersonContentNine extends StatelessWidget {
  const PersonContentNine({super.key});
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                ...
                                'penalty shall be imposed in its maximum period. Any ascendant, guardian, or person entrusted in any capacity '
                                'with the care of a child who shall cause and/or allow such child to be employed or to participate in an obscene '
                                'play, scene, act, movie or show or in any other acts covered by this section shall suffer the penalty of prision mayor in its medium period.\n',
                                textAlign: TextAlign.justify,
                                style: TextStyle(
                                  fontFamily: "RobotoFlex",
                                  fontSize: 16.sp,
...
class PersonContentTen extends StatelessWidget {
  const PersonContentTen({super.key});
...
class PersonContentEleven extends StatelessWidget {
  const PersonContentEleven({super.key});
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                ...
                                'enterprises by the Department of Social Welfare and Development for such period which shall not be less than one (1) year, as the Department may determine. The unauthorized removal of such sign '
                                'shall be punishable by prision correccional. An establishment shall be deemed to promote or facilitate child prostitution and other sexual abuse, '
...
class PersonContentTwelve extends StatelessWidget {
  const PersonContentTwelve({super.key});
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                ...
                                'acquisition of the child. In the above exceptional cases where any such child may be employed, the employer shall first secure, before engaging such child, a work permit from the Department of Labor and Employment which shall ensure observance of the above requirement. '
...
class PersonContentThirteen extends StatelessWidget {
  const PersonContentThirteen({super.key});
...
class PersonContentFourteen extends StatelessWidget {
  const PersonContentFourteen({super.key});
...
class PersonContentFifteen extends StatelessWidget {
  const PersonContentFifteen({super.key});
...
class PersonContentSixteen extends StatelessWidget {
  const PersonContentSixteen({super.key});
...
class PersonContentSeventeen extends StatelessWidget {
  const PersonContentSeventeen({super.key});
...
class PersonContentEighteen extends StatelessWidget {
  const PersonContentEighteen({super.key});
...
class PersonContentNineteen extends StatelessWidget {
  const PersonContentNineteen({super.key});
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 20.h),
                              Text(
                                'The delivery of basic social services in health and nutrition to '
...
class PersonContentTwenty extends StatelessWidget {
  const PersonContentTwenty({super.key});
